...
export default function AirCurtainPage() {
  ...
  const [airCurtainControlType, setAirCurtainControlType] = useState(''); // 'with DDC' | 'Thermostat'
  const [airCurtainControlHardPoints, setAirCurtainControlHardPoints] = useState(''); // 'Statuses' | 'Command' | 'Statuses and Command'
  ...
  // Panel/Protocol integrations
  const [airCurtainIntegration, setAirCurtainIntegration] = useState(''); // 'none' | 'own Panel'
  ...
  const [airCurtainThermostatIntegration, setAirCurtainThermostatIntegration] = useState(''); // 'none' | 'Thermostat'
  ...
  // Dropdown helper (CollectorPage ile birebir aynı format)
  ...
  // ===== Build table rows (CollectorPage tarzı) =====
  const handleSaveAirCurtain = () => {
    ...
    if (heatingFunction === 'On/Off Valve Actuator with Feedback') {
      heatingRows.push(
        { point: 'Heating Valve Command', ai: 0, ao: 0, di: 0, do: 1, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 },
        { point: 'Heating Valve Status', ai: 0, ao: 0, di: 1, do: 0, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 }
      );
    }

    if (heatingFunction === 'Floating Valve Actuator') {
      heatingRows.push(
        { point: 'Heating Valve Open Command', ai: 0, ao: 0, di: 0, do: 1, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 },
        { point: 'Heating Valve Close Command', ai: 0, ao: 0, di: 0, do: 1, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 }
      );
    }
    ...
    if (heatingFunction === 'Floating Valve Actuator with Feedback') {
      heatingRows.push(
        { point: 'Heating Valve Open Command', ai: 0, ao: 0, di: 0, do: 1, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 },
        { point: 'Heating Valve Close Command', ai: 0, ao: 0, di: 0, do: 1, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 },
        { point: 'Heating Valve Open Status', ai: 0, ao: 0, di: 1, do: 0, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 },
        { point: 'Heating Valve Close Status', ai: 0, ao: 0, di: 1, do: 0, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 }
      );
    }
    ...
    if (heatingFunction === 'Proportional Valve Actuator with Feedback') {
      heatingRows.push(
        { point: 'Heating Valve Proportional Command', ai: 0, ao: 1, di: 0, do: 0, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 },
        { point: 'Heating Valve Proportional Feedback', ai: 1, ao: 0, di: 0, do: 0, projectCode, description, location, modbusRtu: 0, modbusTcp: 0, bacnetMstp: 0, bacnetIp: 0, mbus: 0 }
      );
    }
    ...
    if (
      ...
      switch (airCurtainProtocolIntegration) {
        case 'Modbus RTU': row.modbusRtu = pointValue; break;
        case 'Modbus TCP IP': row.modbusTcp = pointValue; break;
        case 'Bacnet MSTP': row.bacnetMstp = pointValue; break;
        case 'Bacnet IP': row.bacnetIp = pointValue; break;
      }
  ...
  // ===== Pool: CollectorPage ile aynı mantık =====
  ...
  const handleAddPool = () => {
    ...
    // Temizleme: CollectorPage davranışı
    setTableRows([]);
    setShowTable(false);
  };
  ...
  return (
    <Box sx={{ minHeight: '100vh', background: 'radial-gradient(circle at top right, #1A237E, #000000)', color: '#FFFFFF', display: 'flex', flexDirection: 'column' }}>
        ...
        <Container maxWidth="sm" sx={{ py: 6, px: 2, maxWidth: '600px', ml: 4, mr: 2 }}>
          <Box sx={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', borderRadius: '12px', p: 4, width: '400px', maxWidth: '100%', maxHeight: '85vh', overflowY: 'auto' }}>
            ...
            <Stack spacing={2}>
              ...
              {renderDropdown('Control Type', airCurtainControlType, (e) => setAirCurtainControlType(e.target.value), ['with DDC', 'Thermostat'])}

              {renderDropdown('Thermostat Integration', airCurtainThermostatIntegration, (e) => setAirCurtainThermostatIntegration(e.target.value), ['none', 'Thermostat'], airCurtainControlType === 'with DDC')}

              {renderDropdown('Thermostat Protocol', airCurtainThermostatProtocol, (e) => setAirCurtainThermostatProtocol(e.target.value), ['Modbus RTU', 'Modbus TCP IP', 'Bacnet MSTP', 'Bacnet IP'], airCurtainControlType === 'with DDC' || airCurtainThermostatIntegration === 'none')}
              ...
              <TextField
                ...
                sx={{
                  '& .MuiOutlinedInput-root .MuiOutlinedInput-notchedOutline': { borderColor: (airCurtainThermostatIntegration === 'none' || airCurtainControlType === 'with DDC') ? '#555' : '#B0BEC5' },
                  '& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: (airCurtainThermostatIntegration === 'none' || airCurtainControlType === 'with DDC') ? '#555' : '#90A4AE' },
                  '& .MuiOutlinedInput-root:hover .MuiOutlinedInput-notchedOutline': { borderColor: (airCurtainThermostatIntegration === 'none' || airCurtainControlType === 'with DDC') ? '#555' : '#CFD8DC' }
                }}
                InputProps={{
                  sx: {
              ...
              {renderDropdown('Heating Power', heatingPower, (e) => setHeatingPower(e.target.value), ['0,55', '0,75', '1,1', '1,5', '2,2', '3', '4', '5,5', '7,5', '11', '15', '18,5', '22', '30', '37', '45', '55', '75', '90', '110', '132', '160'], airCurtainControlType === 'Thermostat' || ['On/Off Valve Actuator', 'On/Off Valve Actuator with Feedback', 'Floating Valve Actuator', 'Floating Valve Actuator with Feedback', 'Proportional Valve Actuator', 'Proportional Valve Actuator with Feedback', 'none'].includes(heatingFunction))}

              {renderDropdown('Heating Voltage', heatingVoltage, (e) => setHeatingVoltage(e.target.value), ['230', '380'], airCurtainControlType === 'Thermostat' || ['On/Off Valve Actuator', 'On/Off Valve Actuator with Feedback', 'Floating Valve Actuator', 'Floating Valve Actuator with Feedback', 'Proportional Valve Actuator', 'Proportional Valve Actuator with Feedback', 'none'].includes(heatingFunction))}
              ...
              <TextField
                ...
                InputLabelProps={{ sx: { color: '#90A4AE', '&.Mui-focused': { color: '#B0BEC5' }, '&.Mui-disabled': { color: '#888' } } }}
                sx={{
                  '& .MuiOutlinedInput-root .MuiOutlinedInput-notchedOutline': { borderColor: (airCurtainControlType === 'Thermostat' || airCurtainIntegration === 'none') ? '#555' : '#B0BEC5' },
                  '& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: (airCurtainControlType === 'Thermostat' || airCurtainIntegration === 'none') ? '#555' : '#90A4AE' },
                  '& .MuiOutlinedInput-root:hover .MuiOutlinedInput-notchedOutline': { borderColor: (airCurtainControlType === 'Thermostat' || airCurtainIntegration === 'none') ? '#555' : '#CFD8DC' }
                }}
                InputProps={{
                  sx: {
      ...
      {/* Snackbar - CollectorPage ile aynı görünüm */}
      <Snackbar
        open={snackbarOpen}
