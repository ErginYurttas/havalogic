        ...
        >
          ...
          <Stack spacing={2}>
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Heat Reclaim Project Code"
              value={projectCode}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Heat Reclaim Description"
              value={description}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Heat Reclaim Located"
              value={location}
            ...
            <PrimaryButton sx={{ width: '100%' }}>Save Heat Reclaim</PrimaryButton>
