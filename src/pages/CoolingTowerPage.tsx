        ...
        >
          ...
          <Stack spacing={2}>
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Cooling Tower Project Code"
              value={projectCode}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Cooling Tower Description"
              value={description}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Cooling Tower Located"
              value={location}
            ...
            <PrimaryButton sx={{ width: '100%' }}>Save Cooling Tower</PrimaryButton>
