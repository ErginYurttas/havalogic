        ...
        >
          ...
          <Stack spacing={2}>
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Chiller Project Code"
              value={projectCode}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Chiller Description"
              value={description}
            ...
            <PrimaryButton sx={{ width: '100%' }}>Save Chiller</PrimaryButton>
