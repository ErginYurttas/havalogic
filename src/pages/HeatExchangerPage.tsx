        ...
        >
          ...
          <Stack spacing={2}>
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Heat Exchanger Project Code"
              value={projectCode}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Heat Exchanger Description"
              value={description}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Heat Exchanger Located"
              value={location}
            ...
            <PrimaryButton sx={{ width: '100%' }}>Save Heat Exchanger</PrimaryButton>
