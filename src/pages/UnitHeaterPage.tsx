        ...
        >
          ...
          <Stack spacing={2}>
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Unit Heater Project Code"
              value={projectCode}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Unit Heater Description"
              value={description}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Unit Heater Located"
              value={location}
            ...
            <PrimaryButton sx={{ width: '100%' }}>Save Unit Heater</PrimaryButton>
