        ...
        >
          ...
          <Stack spacing={2}>
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Water Tank Project Code"
              value={projectCode}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Water Tank Description"
              value={description}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Water Tank Located"
              value={location}
            ...
            <PrimaryButton sx={{ width: '100%' }}>Save Water Tank</PrimaryButton>
