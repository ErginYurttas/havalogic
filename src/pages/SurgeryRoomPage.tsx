        ...
        >
          ...
          <Stack spacing={2}>
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Surgery Room Project Code"
              value={projectCode}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Surgery Room Description"
              value={description}
            ...
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Surgery Room Located"
              value={location}
            ...
            <PrimaryButton sx={{ width: '100%' }}>Save Surgery Room</PrimaryButton>
